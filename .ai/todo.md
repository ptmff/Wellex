...
- [ ] Подключить реальный PSP (ЮKassa/Stripe) вместо `MockPaymentProvider`
...
- [ ] **Добавить `backend/.env.example`** (без секретов продакшена) — README уже ссылается на файл, которого нет
