  ...
  sections: [
    ...
    },
    {
      ...
      list: [
        ...
        "Аналитические — сервис Яндекс.Метрика (ООО «ЯНДЕКС», РФ): счётчик № 113005346, cookie и идентификаторы посетителя, карта кликов, вебвизор, учёт переходов — только после согласия в баннере cookie.",
      ],
    },
    {
      ...
      list: [
        ...
        "Cookie Яндекс.Метрики (_ym_* и др.) — аналитика; устанавливаются после согласия на аналитические cookie.",
      ],
    },
    {
      title: "4. Управление",
